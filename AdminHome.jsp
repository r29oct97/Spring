...
<meta charset="utf-8">
	...
	<%	datapoints=(String)request.getAttribute("analysis"); %>
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title: {
		text: "Capstore Business Analysis"
	},
	subtitles: [{
		text: "Shopping Statistics",
		fontSize: 16
	}],
	axisY: {
		scaleBreaks: {
    ...
    <div class="wrapper" >
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
				...
				<li>
                    <a href="#prodSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Products</a>
                    <ul class="collapse list-unstyled" id="prodSubmenu">
                        <li>
                            <a href="admin_add_product">Add Product</a>
                        </li>
                        <li>
                            <a href="admin_remove_products">Remove Product</a>
                        </li>
                        <!-- <li>
                            <a href="admin_add_productImages">Add Product Image</a>
                        </li> -->
                         </li>
        ...
        <div id="content">
           ...
           <div style="">
            ...
            <marquee><h1 style="color: silver">Welcome Admin</h1></marquee>
           </div>
          <center> <div id="chartContainer" style="height: 450px; width: 100%;"></div></center>
